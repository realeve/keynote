...
var app = function () {
  ...
  var appendThemeList = function appendThemeList() {

    var getDate = function getDate() {
      var jsRight = function jsRight(sr, rightn) {
  ...
  $('body').on('keydown', function (event) {
    ...
    if (key == 27) {
      isFullScreen = false;
    } else if (keyName != 'Control' && keyName != 'F12' && keyName != 'F5' && keyName != 'Alt') {
  ...
  var fixImgFolder = function fixImgFolder() {
    //MD文件默认图片目录
